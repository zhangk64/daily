...
# curl -X 'GET'   'http://yourDomain/api/v1/finding/project/e940f99c-59df-4ae2-8bb9-2c36d88959f2'   -H 'accept: application/json'   -H 'X-Api-Key: XFFoH6tMWILlJQ5UOa5jR6nTIi9CuwFa'
...
def request_report(pid):
    if pid == "":
        return 
    report_data = []
    url = "http://yourDomain/api/v1/finding/project/" + str(pid) 
    try:
        header = {
